...
### 3.3 현재 집 상태
+ 현재의 집 상태를 확인할 수 있는 기능이다.
+ 메인 메뉴에서 3을 입력해 확인 할 수 있으며 집안의 온도를 확인 할 수 있다.

### 3.4 선풍기 조절
+ 스마트폰과의 UART 통신을 통해 사용자 입력을 받아 선풍기를 조작 할 수 있다.
1. 사용자는 4가지 기능 중 하나를 선택해 입력을 보낸다.
2. 1은 정지, 2는 미풍, 3은 중풍, 4는 강풍이다.


### 3.5 전기요금 확인
+ 기기가 동작되고 여태까지 사용한 전기 요금을 확인하는 기능이다.
1. 메인 메뉴에서 5를 입력하여 확인할 수 있다. 
2. 전기요금은 기본적으로 1초에 1씩 올라가게 설정되어 있다.
3. 게임이 시작되면 1초에 3씩 올라가게 설정되어 있다.
